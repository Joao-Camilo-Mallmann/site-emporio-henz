...
<template>
  <button
    ...
    :class="[
      ...
      variant === 'primary' &&
        'bg-amber-800 text-white hover:bg-amber-900 focus:ring-amber-800 shadow-sm',
      variant === 'secondary' &&
        'bg-stone-200 text-stone-900 hover:bg-stone-300 focus:ring-stone-400',
      variant === 'outline' &&
        'border border-stone-300 bg-white text-stone-800 hover:bg-stone-100 focus:ring-stone-400',
    ]"
