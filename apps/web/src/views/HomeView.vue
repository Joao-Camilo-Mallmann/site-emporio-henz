...
<template>
  <div class="space-y-12 md:space-y-16 pb-20 bg-surface-light">
    <!-- Hero Banner (home.png): Fundo azul suave #D2E8F8, Círculo Azul-marinho #123854 e Sofá 3 Lugares -->
    ...
    <!-- Vitrine de 6 Categorias Sobrepondo o Hero (home.png) com Efeitos Ricos de Hover -->
    <section
      class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 sm:-mt-20 lg:-mt-24 relative z-20"
    >
      <div
