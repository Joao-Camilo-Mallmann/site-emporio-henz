...
```vue
<button
  class="bg-primary hover:bg-primary-dark text-white font-medium px-4 py-2 rounded-lg transition-colors"
>
  Comprar Móvel
</button>
```
...
```vue
<button
  class="bg-secondary hover:bg-secondary-hover text-white font-medium px-4 py-2 rounded-lg transition-colors"
>
  Solicitar Orçamento
</button>
```
