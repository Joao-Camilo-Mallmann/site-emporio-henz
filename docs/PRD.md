...
| 9     | Vínculo multi-empresa de vendedores e isolamento de produtos por fornecedor                                                                | Garante a governança centralizada pelo Administrador e o isolamento seguro do catálogo entre marcas parceiras       |
...
| RF15 | O sistema permite ao Administrador vincular usuários com perfil **Vendedor** a uma ou mais empresas/fornecedores simultaneamente através da entidade associativa `user_suppliers`. Usuários com perfil **Administrador** e **Cliente** não necessitam de vínculo com fornecedores.                                                                                                                                                                                                                                                         |
| RF16 | O sistema permite ao **Vendedor** cadastrar e atualizar produtos **exclusivamente das empresas/fornecedores às quais está vinculado**. Caso o vendedor possua vínculo com apenas 1 empresa, ela é pré-definida e bloqueada automaticamente no formulário; caso possua múltiplos vínculos ativos, o sistema restringe o seletor para exibir apenas as empresas que possui autorização.                                                                                                                                                    |
